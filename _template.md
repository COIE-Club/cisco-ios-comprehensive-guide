...
## Overview
[Provide a clear, beginner-friendly explanation of what the technology is, in 2-3 sentences. Focus on what it does, not the deep history.]

## Why it is important
[Explain when and why a network engineer should use this in the real world. Give a practical use case.]

## Topology
![Topology Diagram](./topology.png)
*(Note: Include a clean topology image. Ensure device hostnames and interface IDs in the image match the configuration below.)*

## Requirements
* [e.g., Two Cisco IOS routers (R1 and R2)]
* [e.g., Basic IP connectivity between the devices]
